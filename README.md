# restaurant
### 系统介绍
<p>该西餐厅管理系统是针对前来餐厅食客就餐的流程设计的信息系统。 <br>
首先客人进店后服务员根据人数选定餐台，根据客人所需餐品下单。在这里客人可以选择单点或者套餐，套餐内也提供给了客人一些适度选择的空间。 
在客人完成点单后，生成订单，并发送给后厨，后厨据此制作餐品。 
客人完成就餐后，根据订单金额和相关折扣，买单离开，此时订单完成，系统自动统计营业额。
该系统可以看菜品销售的报表、各种时间段的营业额的报表，还设置了权限，不同工作岗位的系统操作着者有不同的系统操作权限
</p>

### 系统使用技术栈
<p>
 该系统使用的是vue+ vue-router+axios+elementUI+echarts等技术栈。
</p>
